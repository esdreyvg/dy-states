...
export const phoneSchema = z.string()
    .regex(/^(\+1)?\s?8\d{2}[\s-]?\d{3}[\s-]?\d{4}$/, 'Formato de teléfono inválido. Use formato dominicano: 809-123-4567 o +1 809-123-4567');
...
export const userNotificationPreferencesSchema = z.object({
    ...
    channelPreferences: z.record(z.nativeEnum(NotificationChannel), z.object({
        enabled: z.boolean().default(true),
...
export const notificationTemplateSchema = z.object({
    ...
    templates: z.record(z.string().min(2, 'Código de idioma inválido'), z.object({
        title: z.string()
            .min(1, 'Título requerido')
            .max(100, 'Título no puede exceder 100 caracteres'),
        message: z.string()
