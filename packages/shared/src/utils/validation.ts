...
// Area validation
export const validateArea = (area: number | string): { isValid: boolean; message?: string } => {
...
// Year validation
export const validateYear = (year: number | string): { isValid: boolean; message?: string } => {
...
export const validateFileSize = (file: File, maxSize: number = 10 * 1024 * 1024): { isValid: boolean; message?: string } => {
...
// File interface for cross-platform compatibility
interface FileData {
  type: string;
  size: number;
  name?: string;
...
export const validateFileType = (file: FileData, allowedTypes: string[]): { isValid: boolean; message?: string } => {
