...
export const validatePropertySearch = (data: unknown) => propertySearchParamsSchema.parse(data);
export const validatePropertyInquiry = (data: unknown) => propertyInquirySchema.parse(data);
